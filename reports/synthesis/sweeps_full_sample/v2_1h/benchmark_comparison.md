...
| buys_m5_snap | NO (aggregated_order_flow) | NO | C1, C3 | NOT_NOVEL |
...
| impact_asymmetry_pct | NO (execution_quality) | YES | C1, C2, C3 | NOT_NOVEL |
| liq_change_pct | YES | NO | C1, C3 | NOVEL_BUT_NOT_IMPROVED |
| liq_cliff_flag | YES | NO | C1, C3 | NOVEL_BUT_NOT_IMPROVED |
| breadth_positive_pct | NO (momentum_direction) | NO | C1, C3 | NOT_NOVEL |
| breadth_negative_pct | NO (momentum_direction) | NO | C1, C3 | NOT_NOVEL |
| median_pool_r_m5 | NO (momentum_direction) | NO | C1, C3 | NOT_NOVEL |
| pool_dispersion_r_m5 | NO (momentum_direction) | NO | C1, C3 | NOT_NOVEL |
| median_pool_rv5m | YES | NO | C1, C3 | NOVEL_BUT_NOT_IMPROVED |
| pool_liquidity_median | YES | NO | C1, C3 | NOVEL_BUT_NOT_IMPROVED |

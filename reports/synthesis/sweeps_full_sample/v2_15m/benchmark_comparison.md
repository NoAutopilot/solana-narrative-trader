...
| price_usd | NO (static_fundamentals) | NO | C3 | NOT_NOVEL |
...
| avg_trade_usd_m5_snap | YES | NO | C3 | NOVEL_BUT_NOT_IMPROVED |
...
| pool_vol_h1_median | YES | NO | C3 | NOVEL_BUT_NOT_IMPROVED |

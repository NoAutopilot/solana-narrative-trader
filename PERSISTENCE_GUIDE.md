...
| Helius RPC | API Key | `b9ca49f2-526d-4bef-87a0-7d143dac2480` |
| Wallet | Address | `D714dunm7nYGz5acTWvHpHqTMzUzh847tRcQ6x7i8rw9` |
...
# 2. Wallet balance
python3 -c "import requests; r=requests.post('https://mainnet.helius-rpc.com/?api-key=b9ca49f2-526d-4bef-87a0-7d143dac2480', json={'jsonrpc':'2.0','id':1,'method':'getBalance','params':['D714dunm7nYGz5acTWvHpHqTMzUzh847tRcQ6x7i8rw9']}); print(f\"Wallet: {r.json()['result']['value']/1e9:.6f} SOL\")"

...
|---------|--------|-------------|----------------------|--------|
| age_hours | NO (static_fundamentals) | NO | C3 | NOT_NOVEL |
| liquidity_usd | NO (static_fundamentals) | NO | C3 | NOT_NOVEL |
| vol_h1 | NO (static_fundamentals) | NO | C3 | NOT_NOVEL |
| vol_h24 | NO (static_fundamentals) | NO | C1, C3 | NOT_NOVEL |
| price_usd | NO (static_fundamentals) | NO | C1, C3 | NOT_NOVEL |
| buys_m5 | NO (aggregated_order_flow) | YES | C1, C2, C3 | NOT_NOVEL |
| sells_m5 | NO (aggregated_order_flow) | YES | C1, C2, C3 | NOT_NOVEL |
...
| r_m5_micro | NO (momentum_direction) | YES | C1, C2, C3 | NOT_NOVEL |
| rv_5m | YES | NO | C1, C3 | NOVEL_BUT_NOT_IMPROVED |
| rv_1m | YES | YES | C1, C2, C3 | NOVEL_AND_IMPROVED |
| range_5m | YES | NO | C1, C3 | NOVEL_BUT_NOT_IMPROVED |
| buys_m5_snap | NO (aggregated_order_flow) | NO | C3 | NOT_NOVEL |
| sells_m5_snap | NO (aggregated_order_flow) | NO | C3 | NOT_NOVEL |
| buy_count_ratio_m5_snap | NO (aggregated_order_flow) | NO | C1, C3 | NOT_NOVEL |
| avg_trade_usd_m5_snap | YES | NO | C1, C3 | NOVEL_BUT_NOT_IMPROVED |
| jup_vs_cpamm_diff_pct | NO (execution_quality) | NO | C1, C3 | NOT_NOVEL |
| round_trip_pct | NO (execution_quality) | NO | C3 | NOT_NOVEL |
| impact_buy_pct | NO (execution_quality) | NO | C3 | NOT_NOVEL |
| impact_sell_pct | NO (execution_quality) | NO | C3 | NOT_NOVEL |
...
| median_pool_rv5m | YES | NO | C3 | NOVEL_BUT_NOT_IMPROVED |
| pool_liquidity_median | YES | NO | C3 | NOVEL_BUT_NOT_IMPROVED |
| pool_vol_h1_median | YES | NO | C1, C3 | NOVEL_BUT_NOT_IMPROVED |
| pool_size_total | YES | NO | C3 | NOVEL_BUT_NOT_IMPROVED |
| pool_size_with_micro | YES | NO | C3 | NOVEL_BUT_NOT_IMPROVED |
| coverage_ratio_micro | YES | NO | C3 | NOVEL_BUT_NOT_IMPROVED |

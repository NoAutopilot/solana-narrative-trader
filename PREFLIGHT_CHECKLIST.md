...
python3 -c "
import requests
HELIUS_RPC='https://mainnet.helius-rpc.com/?api-key=b9ca49f2-526d-4bef-87a0-7d143dac2480'
...
# Wallet
r = requests.post('https://mainnet.helius-rpc.com/?api-key=b9ca49f2-526d-4bef-87a0-7d143dac2480',
    json={'jsonrpc':'2.0','id':1,'method':'getBalance','params':['D714dunm7nYGz5acTWvHpHqTMzUzh847tRcQ6x7i8rw9']}, timeout=10)
bal = r.json()['result']['value'] / 1e9
